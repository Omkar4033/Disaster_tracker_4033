...
const App = () => {
  ...
  const [infobox, setinfobox] = useState({ id: null, title: null, url: null,category:null });
    ...
    <div>
      ...
      Volcano Tracker
            ...
            <div className="calamties_chart">
              ...
              <PieChart
                data={[
                  { text: "One", value: 10, color: "#FEDEFF",fontColor: "black" },
                  { title: "Two", value: 15, color: "#93C6E7" },
                  { title: "Three", value: 20, color: "#B9F3FC" },
                ]}
              />
              ;
            </div>
